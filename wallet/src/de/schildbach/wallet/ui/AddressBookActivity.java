...
public final class AddressBookActivity extends AbstractBindServiceActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (pager != null) {
            pager.setAdapter(
                    new TwoFragmentAdapter(fragmentManager, walletAddressesFragment, sendingAddressesFragment, this));
    ...
    private static class TwoFragmentAdapter extends PagerAdapter {
        ...
        public TwoFragmentAdapter(final FragmentManager fragmentManager, final Fragment left, final Fragment right, Context context) {
        ...
        public CharSequence getPageTitle(int position) {
            return position == 0 ? context.getResources().getString(R.string.address_book_list_receiving_title)
                    : context.getResources().getString(R.string.address_book_list_sending_title);
        }
